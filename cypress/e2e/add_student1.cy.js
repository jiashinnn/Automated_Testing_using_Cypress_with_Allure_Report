describe("Add Student 1 - Test Student Details Only", () => {
  ...
  const testSuites = [
    ...
    },
    {
      ...
      tests: [
        { value: undefined, shouldPass: true },
        { value: 'johngmail.com', shouldPass: false },
        { value: '!;1john@gmail.com', shouldPass: false },
        { value: 'admin@gmail', shouldPass: false },
    ...
    },
    {
      ...
      tests: [
        ...
        { value: '@#^&*$%', shouldPass: false },
        { value: '', shouldPass: false },
        { value: '3784272184', shouldPass: false },
      ],
    },
    {
      field: "b_date",
    ...
    },
    {
      field: "fileToUpload",
      tests: [
        { value: 'student.jpg', shouldPass: true },
        { value: 'student.txt', shouldPass: false },
      ],
    },
  ];
